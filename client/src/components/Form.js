...
const Form = ({fetchUsersData, BASE_URL}) => {
  ...
  const handleSubmit = (event) => {
    event.preventDefault();           //after submit button we dont want page to reload, so onsubmit we wrote this.
    // To submit the Data
    submitData();
    // But Empty the previous Details      //whn we click on submit it will empty previous values.
    setUserName("");
    setUserEmail("");
  };
  return (
